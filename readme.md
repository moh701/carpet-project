the project is to create an online store called CARPET for the global carpet industry.
The objective is to develop a web-based platform that connects carpet customers and producers, facilitating collaboration and communication among industry professionals.
The platform aims to provide carpet producers and suppliers with tools to showcase their products, manage orders, and monitor customer feedback, while offering customers an intuitive interface for browsing, comparing, and purchasing carpets from various suppliers worldwide.
The main functionalities of the online store include sections for producers, customers, products, orders, and comments.
 In the producer section, sellers can create and manage their accounts, add and edit products, manage orders, and communicate with customers.
The customer section allows customers to create and manage their accounts, view order history, and update personal information.
