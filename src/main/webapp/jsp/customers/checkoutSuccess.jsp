        ...
        <div class="row g-5">
            ...
            <div class="col-md-7 col-lg-8">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <div class="row">
                            <p class="p-0 m-0 pt-2 text-muted small">Order 123456789</p>
                        </div>
                        <div class="row">
                            <p class="p-0 m-0">
                                Thank you, {Name}
                ...
                <h3 class="pb-2">Customer Information</h3>
                <div class="row">
                    <div class="col">
                        <p class="p-0 m-0"><strong>Shipping Address</strong></p>
                        <p class="p-0 m-0"><c:out value="${customer.firstname}" /> <c:out value="${customer.lastname}" /></p>
                        <p class="p-0 m-0"><c:out value="${customer.address}" /></p>
                        <p class="p-0 m-0">Address - City</p>
                        <p class="p-0 m-0">Address - Country</p>
                        <br>
                        <p class="p-0 m-0"><strong>Shipping Method</strong></p>
                        <p class="p-0 m-0">Result - Shipping Method</p>
                        <p class="p-0 m-0">Deliverytime</p>
                    </div>
                    <div class="col">
                        <p class="p-0 m-0"><strong>Billing Address</strong></p>
                        <p class="p-0 m-0"><c:out value="${customer.firstname}" /> <c:out value="${customer.lastname}" /></p>
                        <p class="p-0 m-0"><c:out value="${customer.address}" /></p>
                        <p class="p-0 m-0">Address - City</p>
                        <p class="p-0 m-0">Address - Country</p>
                        <br>
                        <p class="p-0 m-0"><strong>Payment Method</strong></p>
                        <p class="p-0 m-0">Result - Payment Method</p>
                    </div>
                </div>
                <hr>
            </div>
