...
<body>
<div class="container">
  <form method = "POST" id = "customer-login-form" action="<c:url value="/customers/login/"/>" class="row g-3 position-absolute top-50 start-50 translate-middle">
    ...
    <div class="col-12">
      ...
      <a href="<c:url value="/customers/forgetPassword/"/>" class="ms-2">Forget Password?</a>
      <a href="<c:url value="/customers/register/"/>" class="ms-2">Don't you have an account?</a>
