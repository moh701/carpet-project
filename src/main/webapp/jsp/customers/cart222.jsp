...
<%@ page import="it.unipd.dei.webapp.resource.CartItem" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <main>
        <div class="order-md-last">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                ...
                <p>String to print: <%= "Hello, I am in cart222.jsp!" %></p>

            <%-- Retrieve list of shopping basket from servlet request and calculate total price --%>
                <%
                ...
                %>
                <span class="badge bg-primary rounded-pill">%= cartItems.size() %></span>
            </h4>
            <ul class="list-group mb-3">
                <% for (CartItem cartItem : cartItems) { %>
                <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                        <h6 class="my-0"><%= cartItem.getProductName() %></h6>
                        <small class="text-body-secondary"><%= "..." %></small> <!--it can be serialNo of each product-->
                    </div>
                    <span class="text-body-secondary"><%= cartItem.getPrice() %></span>
                </li>
                <% } %>
            ...
            <div class="d-flex justify-content-center">
                <form action="<c:url value="/cart/cheakPurchase/"/>" method="POST">
                    <button class="btn btn-primary btn-lg" type="submit">Continue to checkout</button>
                </form>
            </div>
...
<script src="../../HTMLfrontendjs/myJS/checkout.js"></script>
